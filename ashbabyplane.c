...
scanf("%d",&typeclass);
    ...
    int result =strcmp(board,"Delhi");//inserted
    int result2=strcmp(destination,"Mumbai");//inserted
    if(result==1)
    {
	      if(result2==1)
        {
 ...
 result2=strcmp(destination,"hyderabad");
        ...
        result2 =strcmp(destination,"Madras");
        ...
        if(result2==1)
        {
           ...
           scanf("%d",&u);
            ...
            result2=strcmp(destination,"nagpur");
    ...
    result=strcmp(board,"mumbai");

    
    if(result==1)
    { 
        result2=strcmp(destination,"delhi");

        if(result2==1);
        {/*
            printf("13878 Bombay Express\t?5,000\n8:00am\t18hrs Journey\n");
            printf("15698 CSMT Express\t?4,000\n10:00pm\t25hrs Journey\n");
            scanf("%d",&train);*/
    ...
    result=strcmp(board,"hyderabad");
    result2=strcmp (destination,"mumbai");
if(result==1)
    {
        if(result2==1);
        {
...
if(result==1)
{
    ...
    if(result2==1)
    {
          printf("The flights available forNagpur to Madras are:\n");
           printf("flight number\t flight \t depaarture\t arrival\t Journey time \t Price\n");
